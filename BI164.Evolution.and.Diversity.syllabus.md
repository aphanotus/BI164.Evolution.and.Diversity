...
You should complete the assigned readings, ideally before each class. [Reading guides](https://github.com/aphanotus/BI164.Evolution.and.Diversity/blob/main/reading.guides.md#bi164-reading-guides) are available to help direct your attention to key elements of each chapter. Basic information provided in the readings, such as vocabulary, will be a focus of weekly quizzes.
...
| course component                    | number              | points each   | total points |
| :---------------------------------- | :----: | :----: | :----: |
| Lab  |   |   |  300  |
| In-class engagement |  |  |  70  |
| Problem sets | 3 | 20 | 60 |
| Quizzes | 9 | 10 |  90  |
| Midterm exams | 3 | 120 |  360  |
| Cumulative final exam              | 1             |               |  120  |
| **total**                          |                           |                           | 1,000  |
